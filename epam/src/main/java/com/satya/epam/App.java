...
public class App 
{
    public static void main( String[] args )
    {
        ...
        s.add(new Chacolate("DairyMilk",180,200.0f,62));
        s.add(new Chacolate("KitKat",20,50.5f,50));
        s.add(new Chacolate("MilkyBar",10,20.4f,40));
        s.add(new Chacolate("FerreroRocher",200,180.7f,75));
		...
		for(int i=0;i<n;i++) {
			if(s.get(i) instanceof Chacolate) ch.add(s.get(i));
		}
		...
		System.out.println("Chacolates Present in the Gift are:");
